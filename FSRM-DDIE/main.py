...
class ProjectNetwork(nn.Module):
    ...
    def forward(self, node_feat, edge_feat):
        ...
        dis = torch.exp(-self.distance(s_feat,q_feat)).view(-1,NUM_WAYS,1)
...
class RelationNetwork(nn.Module):
    ...
    def __init__(self):
        ...
        self.layer2 = nn.Sequential(
                        ...
                        nn.ReLU(),
                        nn.MaxPool1d(5))
        self.fc0 = nn.Sequential(nn.Linear(12, 100), self.reluDrop, nn.BatchNorm1d(100)) # 5way-12 10way-22
...
def main():
    ...
    sys.stdout = Logger(str(excludeLabel)+'-fewer5-fsrmddie.txt')
    ...
    project_network_scheduler = StepLR(project_network_optim, step_size=100000, gamma=0.5)
